...
public class Main {
    public static void main(String[] args) {
        ...
        /*harder question: create a 1 question quiz game as in, ask a question 
        and compare the response to what the correct answer should be. print out
        an appropriate response based on whether it was right or wrong
        i'm expecting an if/else statement likely, google if/else in java!
        */
